# Generated by Powerlevel10k configuration wizard on 2026-03-16 at 18:06 GMT.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=39 # note to self - end of prompt
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON='UT:'
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_NUM_STAGED     )) && res+=" S:${VCS_STATUS_NUM_STAGED}"
    # !42 if have unstaged changes.
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" US:${VCS_STATUS_NUM_UNSTAGED}"
